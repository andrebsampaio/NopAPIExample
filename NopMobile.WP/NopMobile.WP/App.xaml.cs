...
namespace NopMobile.WP
{
    public partial class App : Application
    {
        ...
        public static T FindResource<T>(DependencyObject initial, string key) where T : DependencyObject
        {
        ...
        {
            var Uri = App.RootFrame.Content as PhoneApplicationPage;
            (Application.Current.RootVisual as PhoneApplicationFrame).Navigate(new Uri(Uri.NavigationService.CurrentSource + "?no-cache=" + Guid.NewGuid(), UriKind.Relative));
        }
    }
}